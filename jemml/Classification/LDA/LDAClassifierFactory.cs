...
{
    public class LDAClassifierFactory<T> : ClassifierFactory<T> where T : ISample
    {
        ...
        public override ClassifierInstance CreateInstance(List<ISample> trainingSamples, double[] featureScaling, double[] featureShift, string[] trainingIdentifiers)
        {
            ...
            IClassifier classifier = new LinearDiscriminantAnalysisClassifier(config, trainingSamples, trainingIdentifiers);
