...
namespace jemml.Classification.MLP
{
    public class MultiMLPClassifier : MLPClassifier
    {
        ...
        public MultiMLPClassifier(int hiddenLayers, INetworkTrain networkTrainer, int maxIterations, double minError, List<ISample> trainingSamples, string[] trainingIdentifiers) :
        ...
        protected override void Train(int hiddenLayers, INetworkTrain networkTrainer, int maxIterations, double minError, List<ISample> trainingSamples, string[] trainingIdentifiers)
        {
