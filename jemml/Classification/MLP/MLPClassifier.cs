...
{
    public class MLPClassifier : Classifier
    {
        [JsonProperty]
        ...
        public MLPClassifier(int hiddenLayerNodes, NetworkTrain networkTrainer, double maxIterations, double minError, List<Sample> trainingSamples, string[] trainingIdentifiers)
        {
            Train(hiddenLayerNodes, networkTrainer, maxIterations, minError, trainingSamples, trainingIdentifiers);
        }

        protected virtual void Train(int hiddenLayerNodes, NetworkTrain networkTrainer, double maxIterations, double minError, List<Sample> trainingSamples, string[] trainingIdentifiers)
        {
        ...
        protected BasicNetwork TrainNetwork(int hiddenLayerNodes, NetworkTrain networkTrainer, double maxIterations, double minError, List<Sample> trainingSamples, int outputs, Func<Sample, double[]> idealFunction)
        {
